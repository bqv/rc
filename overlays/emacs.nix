    ...
    weechat-patched = super.weechat.overrideAttrs (o: {
      patches = (o.patches or []) ++ [
        (final.fetchpatch {
          ...
          sha256 = "bgF3WhIl9/NHeTS3wPFtLOily1y8W952DVOPWes2Lkg=";
        })
        (final.fetchpatch {
        ...
        (final.fetchpatch {
          ...
          sha256 = "o21h6K0LKTPE1hNEShyqJw1YEg1ojOrOdQElEYRhzPY=";
        })
        (final.fetchpatch {

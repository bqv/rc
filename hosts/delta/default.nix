{ config, lib, pkgs, usr, system, flakes, hosts, ... }:

{
  ...
  virtualisation.anbox.enable = true;#builtins.trace "${config.networking.hostName} - anbox: still f****d by kernel updates" false;
